export default function ContactSection() {
  const socialLinks = [
  {
    ...
    href: 'https://instagram.com/zeeshancharolia21',
  ...
  },
  {
    ...
    href: 'https://www.linkedin.com/in/zeeshancharolia/',
  ...
  href: 'mailto:charoliazeeshan@gmail.com',
  color: 'hover:bg-gray-600'
}
];
  return (
    <section className="text-white py-16 relative overflow-hidden font-[Book_Antiqua]">
      ...
      <div className="flex justify-center gap-4">
        {socialLinks.map((social, index) => (
          <a
            ...
            className={`group relative p-4 bg-black rounded-full transition-all duration-300 transform hover:scale-110 ${social.color} hover:text-white`}
          ...
          >
            ...
            {/* Tooltip */}
            <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-black text-white text-xs py-1 px-3 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
              {social.name}
